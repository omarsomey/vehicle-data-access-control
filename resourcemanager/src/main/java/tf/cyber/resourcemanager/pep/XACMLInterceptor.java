...
import tf.cyber.resourcemanager.pep.annotation.attributes.*;
import tf.cyber.resourcemanager.pep.data.XACMLAttribute;
import tf.cyber.resourcemanager.pep.obligation.Obligation;
import tf.cyber.resourcemanager.pep.obligation.ObligationService;
...
import static tf.cyber.resourcemanager.pep.util.XACMLConstants.*;
...
public class XACMLInterceptor {
    ...
    @Around("@annotation(tf.cyber.resourcemanager.pep.annotation.XACMLAccessControl)" +
            " || @within(tf.cyber.resourcemanager.pep.annotation.XACMLAccessControl)")
