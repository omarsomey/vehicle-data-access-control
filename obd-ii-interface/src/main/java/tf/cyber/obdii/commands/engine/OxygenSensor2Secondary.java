...
public class OxygenSensor2Secondary extends OBD2Command<Pair<Double, Double>> {
    @Override
    ...
    public String getFriendlyName() {
        return "Oxygen Sensor 2 - (Air-Fuel Equivalence Ratio, Voltage)";
    }

    @Override
    public String getKey() {
        return "oxygen_sensor2_afer_voltage";
    }
}
