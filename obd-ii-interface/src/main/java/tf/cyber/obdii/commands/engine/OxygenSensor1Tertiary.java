...
public class OxygenSensor1Tertiary extends OBD2Command<Pair<Double, Double>> {
    @Override
    ...
    public String getFriendlyName() {
        return "Oxygen Sensor 1 - (Air-Fuel Equivalence Ratio, Current)";
    }

    @Override
    public String getKey() {
        return "oxygen_sensor1_afer_current";
    }
}
